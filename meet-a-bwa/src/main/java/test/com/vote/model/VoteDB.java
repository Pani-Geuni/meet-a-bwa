...
public interface VoteDB {
	...
	String SQL_VOTE_SELECT_ALL_A = "SELECT VOTE_NO, VOTE_TITLE, VOTE_DESCRIPTION, TO_CHAR(VOTE_EOD, 'YYYY³â MM¿ù DDÀÏ'), VOTE_STATE, USER_NO, ACTIVITY_NO, USER_CNT FROM VOTE_USER_VIEW WHERE ACTIVITY_NO=? ORDER BY VOTE_NO DESC";
}
