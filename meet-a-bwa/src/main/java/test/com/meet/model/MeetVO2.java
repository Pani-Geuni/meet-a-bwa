...
public class MeetVO2 {
	...
	public MeetVO2(String meet_no, String meet_image, String meet_name, String meet_description, String meet_county,
			String meet_interest_name, String meet_gender, Integer meet_nop, Integer meet_age, Date meet_date,
			String user_no, Integer like_cnt, Integer user_cnt) {
		super();
	...
	public int hashCode() {
		return Objects.hash(like_cnt, meet_age, meet_county, meet_date, meet_description, meet_gender, meet_image,
				meet_interest_name, meet_name, meet_no, meet_nop, user_cnt, user_no);
	}
	...
	public String toString() {
		return "MeetVO2 [meet_no=" + meet_no + ", meet_image=" + meet_image + ", meet_name=" + meet_name
				...
				+ meet_age + ", meet_date=" + meet_date + ", user_no=" + user_no + ", like_cnt=" + like_cnt
				+ ", user_cnt=" + user_cnt + "]";
	}
