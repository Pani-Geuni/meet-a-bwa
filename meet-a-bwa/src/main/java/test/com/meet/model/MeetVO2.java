...
public class MeetVO2 {
	...
	public MeetVO2(String meet_no, String meet_image, String meet_name, String meet_description, String meet_city,
			String meet_county, String meet_interest_name, String meet_gender, Integer meet_nop, Integer meet_age,
			Date meet_date, String user_no, Integer like_cnt) {
		super();
	...
	@Override
	public int hashCode() {
		return Objects.hash(like_cnt, meet_age, meet_city, meet_county, meet_date, meet_description, meet_gender,
				meet_image, meet_interest_name, meet_name, meet_no, meet_nop, user_no);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MeetVO2 other = (MeetVO2) obj;
		return Objects.equals(like_cnt, other.like_cnt) && Objects.equals(meet_age, other.meet_age)
				&& Objects.equals(meet_city, other.meet_city) && Objects.equals(meet_county, other.meet_county)
				&& Objects.equals(meet_date, other.meet_date)
	...
	public String toString() {
		return "MeetVO2 [meet_no=" + meet_no + ", meet_image=" + meet_image + ", meet_name=" + meet_name
