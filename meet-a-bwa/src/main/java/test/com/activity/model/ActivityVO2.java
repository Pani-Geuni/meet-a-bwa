...
public class ActivityVO2 {
	...
	public ActivityVO2(String activity_no, String activity_image, String activity_name, String activity_description,
			...
			Integer like_cnt, Integer user_cnt) {
		super();
	...
	public int hashCode() {
		return Objects.hash(activity_age, activity_city, activity_county, activity_date, activity_description,
				...
				like_cnt, meet_no, user_cnt, user_no);
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ActivityVO2 other = (ActivityVO2) obj;
