...
//	String strDate = dateFormat.format(Calendar.getInstance().getTime());
	...
	String SQL_ID_CHECK = "select * from test_test_user where user_id=?";
	String SQL_NICK_CHECK = "select * from test_test_user where user_nickname=?";
	String SQL_EMAIL_CHECK = "select * from test_test_user where user_email=?";
}
