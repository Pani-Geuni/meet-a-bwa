...
//	String strDate = dateFormat.format(Calendar.getInstance().getTime());
	...
	String SQL_USER_INSERT = "insert into test_user(user_no, user_image, user_id, user_pw, user_name, user_nickname, user_email, user_tel, user_birth, user_gender, user_interest, user_city, user_county, user_state) values('S'||SEQ_TEST.nextval,?,?,?,?,?,?,?,?,?,?,?,?,'y')";
