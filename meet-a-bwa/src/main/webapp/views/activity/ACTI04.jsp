...
<link rel="stylesheet"
	...
	<link rel="stylesheet" href="/meet-a-bwa/resources/css/activity/update.css" />
	...
	<form action="Activity_insertOK.do" method="post" enctype="multipart/form-data">
		...
		<div class="activityCUDWrap">
			...
			<section id="introducediv">
				...
				<textarea rows="8" cols="36" maxlength="500" placeholder="액티비티에 대해서 자세하게 설명해주세요." id="activity_description"
			...
			<input type="button" id="update_activity_information_btn" value="액티비티정보수정" />
